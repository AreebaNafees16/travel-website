    ...
    const services = [
        {
            ...
            description:
                "Seamless flight booking services to get you to your destination with ease.",
            image: "/flightbooking.jpg",
        },
        {
            title: "Hotel Reservations",
            description:
                "Book the best accommodations tailored to your needs and preferences.",
            image: "/reservation.jpg",
        },
        {
            title: "Tour Packages",
            description:
                "Curated tour packages to explore breathtaking destinations.",
            image: "/tourpackage.jpg",
        },
        {
            title: "Travel Insurance",
            description:
                "Comprehensive travel insurance for a safe and worry-free journey.",
            image: "/insurance.jpg",
        },
        {
            title: "Car Rentals",
            description:
                "Affordable car rental services for convenient travel at your destination.",
            image: "/car.jpg",
        },
        {
            title: "Custom Itineraries",
            description:
                "Tailor-made itineraries to suit your travel preferences and schedule.",
            image: "/planing.jpg",
        },
    ];
